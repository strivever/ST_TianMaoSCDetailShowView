...
- (void)setimageLinkURL:(NSArray *)imageLinkURL
{
    ...
    _leftImageView.image = [UIImage imageNamed:imageLinkURL[leftImageIndex]];
    _centerImageView.image = [UIImage imageNamed:imageLinkURL[centerImageIndex]];
    _rightImageView.image = [UIImage imageNamed:imageLinkURL[rightImageIndex]];
}
...
{
    if (PageControlShowStyle == UIPageControlShowStyleNone || _imageLinkURL.count < 2) {
        return;
    }
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    ...
    [_leftImageView setImage:[UIImage imageNamed:_imageLinkURL[leftImageIndex]]];
    [_centerImageView setImage:[UIImage imageNamed:_imageLinkURL[centerImageIndex]]];
    [_rightImageView setImage:[UIImage imageNamed:_imageLinkURL[rightImageIndex]]];
